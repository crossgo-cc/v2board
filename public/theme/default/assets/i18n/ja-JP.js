window.settings.i18n['ja-JP'] = {
  ...
  '购买后立即清零已用流量，不改变套餐总量和到期时间。': '購入後、データ容量や有効期限を変更せず、使用済みデータ量をすぐにリセットします。',
  '有效': '有効',
  '流量使用': 'データ使用量',
  '已使用': '使用済み',
  '剩余流量': '残りデータ量',
  ...
  '自动续费': '自動継続',
  '自动重置流量': '通信量自動リセット',
  '自动续费说明': '有効期限の3日前から、残高から自動的に引き落として現在のプランを更新します。残高不足の場合はこのスイッチをオフにし、通知メールを送信します。',
  '自动重置流量说明': '通信量使用率が90%に達すると、残高から自動的に引き落として通信量リセットパッケージを購入します。残高不足の場合はこのスイッチをオフにし、通知メールを送信します。',
  '充值': 'トップアップ',
  '礼品卡': 'ギフトカード',
