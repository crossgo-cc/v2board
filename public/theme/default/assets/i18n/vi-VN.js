window.settings.i18n['vi-VN'] = {
  ...
  '免费': 'Miễn phí',
  '购买流量重置包': 'Mua gói đặt lại dữ liệu',
  '购买后立即清零已用流量，不改变套餐总量和到期时间。': 'Đặt lại dữ liệu đã dùng ngay sau khi mua mà không thay đổi tổng dung lượng hoặc ngày hết hạn.',
  '有效': 'Đang hoạt động',
  '流量使用': 'Sử dụng dữ liệu',
  '已使用': 'Đã dùng',
  '剩余流量': 'Còn lại',
  '在线设备': 'Thiết bị trực tuyến',
  '立即重置': 'Đặt lại ngay',
  '待支付': 'Đợi Thanh Toán',
  '开通中': 'Đang xử lý',
  '已取消': 'Đã Hủy',
  ...
  '自动重置流量': 'Tự động đặt lại lưu lượng',
  '自动续费说明': 'Trong 3 ngày trước khi hết hạn, tự động trừ từ số dư để gia hạn gói hiện tại. Nếu số dư không đủ, tùy chọn này sẽ bị tắt và một email thông báo sẽ được gửi.',
  '自动重置流量说明': 'Khi mức sử dụng lưu lượng đạt 90%, tự động trừ từ số dư để mua gói đặt lại lưu lượng. Nếu số dư không đủ, tùy chọn này sẽ bị tắt và một email thông báo sẽ được gửi.',
  '充值': 'Nạp tiền',
  '礼品卡': 'Thẻ quà tặng',
