window.settings.i18n['fa-IR'] = {
  ...
  '免费': 'رایگان',
  '购买流量重置包': 'خرید بسته بازنشانی داده',
  '购买后立即清零已用流量，不改变套餐总量和到期时间。': 'پس از خرید، داده مصرف‌شده فوراً بازنشانی می‌شود و حجم کل و تاریخ انقضا تغییر نمی‌کند.',
  '有效': 'فعال',
  '流量使用': 'مصرف داده',
  '已使用': 'مصرف‌شده',
  '剩余流量': 'باقی‌مانده',
  ...
  '公告': 'هشدارها',
  '公告中心': 'مرکز اطلاعیه‌ها',
  '最新': 'جدیدترین',
  '置顶': 'سنجاق‌شده',
  '查看全部': 'مشاهده همه',
  '暂无公告': 'اطلاعیه‌ای وجود ندارد',
  '上一页': 'قبلی',
  '下一页': 'بعدی',
  '总览': 'بررسی کلی',
  ...
  '自动续费': 'تمدید خودکار',
  '自动重置流量': 'بازنشانی خودکار ترافیک',
  '自动续费说明': 'در ۳ روز پیش از انقضا، به‌طور خودکار از موجودی شما برای تمدید طرح فعلی کسر می‌شود. در صورت کافی نبودن موجودی، این گزینه خاموش شده و ایمیل اطلاع‌رسانی ارسال می‌گردد.',
  '自动重置流量说明': 'هنگامی که مصرف ترافیک به ۹۰٪ برسد، به‌طور خودکار از موجودی شما برای خرید بسته بازنشانی ترافیک کسر می‌شود. در صورت کافی نبودن موجودی، این گزینه خاموش شده و ایمیل اطلاع‌رسانی ارسال می‌گردد.',
  '充值': 'شارژ کنید',
  '礼品卡': 'کارت هدیه',
