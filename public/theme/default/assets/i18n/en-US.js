window.settings.i18n['en-US'] = {
  ...
  '免费': 'Free',
  '购买流量重置包': 'Purchase Data Reset Package',
  '购买后立即清零已用流量，不改变套餐总量和到期时间。': 'Resets used data immediately after purchase without changing the total data allowance or expiration date.',
  '待支付': 'Pending Payment',
  '开通中': 'Pending Active',
  '已取消': 'Canceled',
  '已完成': 'Completed',
  ...
  '自动续费': 'Auto Renewal',
  '自动重置流量': 'Auto Traffic Reset',
  '自动续费说明': '3 days before expiration, the balance will be used to renew the current plan (same period as the last order). If the balance is insufficient, this switch will be turned off and a notification email will be sent.',
  '自动重置流量说明': 'When traffic reaches 90%, the balance will be used to buy the reset package and clear used traffic. If the balance is insufficient, this switch will be turned off and a notification email will be sent.',
  '温馨提示': 'Friendly Reminder',
  '请确保账户余额充足说明': 'Auto Renewal / Auto Traffic Reset will be charged from your balance. Please top up in advance to keep enough balance.',
  '充值': 'Top Up',
  '礼品卡': 'Gift Card',
