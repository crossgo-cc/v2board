window.settings.i18n['en-US'] = {
  ...
  '自动续费说明': 'Within 3 days before expiration, automatically deducts from your balance to renew the current plan. If the balance is insufficient, this switch will be turned off and a notification email will be sent.',
  '自动重置流量说明': 'When traffic usage reaches 90%, automatically deducts from your balance to purchase a traffic reset package. If the balance is insufficient, this switch will be turned off and a notification email will be sent.',
  '充值': 'Top Up',
  '礼品卡': 'Gift Card',
