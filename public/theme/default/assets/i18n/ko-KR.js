window.settings.i18n['ko-KR'] = {
  ...
  '购买后立即清零已用流量，不改变套餐总量和到期时间。': '구매 후 총 데이터 용량과 만료일은 변경하지 않고 사용량을 즉시 초기화합니다.',
  '有效': '사용 중',
  '流量使用': '데이터 사용량',
  '已使用': '사용됨',
  '剩余流量': '남은 데이터',
  ...
  '自动续费': '자동갱신',
  '自动重置流量': '트래픽 자동 초기화',
  '自动续费说明': '만료 3일 전부터 잔액에서 자동으로 차감하여 현재 요금제를 갱신합니다. 잔액이 부족하면 이 스위치가 꺼지고 알림 메일이 전송됩니다.',
  '自动重置流量说明': '트래픽 사용량이 90%에 도달하면 잔액에서 자동으로 차감하여 트래픽 초기화 패키지를 구매합니다. 잔액이 부족하면 이 스위치가 꺼지고 알림 메일이 전송됩니다.',
  '充值': '충전하다',
  '礼品卡': '기프트 카드',
